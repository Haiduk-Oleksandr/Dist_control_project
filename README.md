...
LM35 забезпечує вимір температури з точністю ± 0.25 °C в повному діапазоні робочих температур -55 ... +150 °C, без зовнішньої калібрування або підгонки вихідної напруги.
Підтримуваний граічний інтерфейс - VideoCore VI, що підтримує OpenGL ES 3.x.

### Підключення
Датчик TMP35 має три виводи (три ноги) - земля, живлення та вихідний сигнал.
