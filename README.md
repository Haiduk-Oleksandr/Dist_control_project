...
### Підключення
Датчик TMP35 має три висновки (три ноги). Якщо подивитися на датчик з боку цих висновків і зрізом вгору, то зліва буде - позитивний контакт живлення (+2.7 - 5.5В), по центру - вихід на контролер, і справа - негативний контакт живлення (земля).
